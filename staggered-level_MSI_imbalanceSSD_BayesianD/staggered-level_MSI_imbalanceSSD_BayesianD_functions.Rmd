---
title: "staggered-level_MSI_imbalanceSSD_BayesianD_functions"
...
generateSLD <- function(m1, m2, m3, b1, n2){
  ...
  for(i in 1:m1){
    ...
    wholeplot1[ ,i] <- rep(sample(tem.w1,size = b1,replace = T), each = n2)  
  }
  
  for(i in 1:m2){
    
    wholeplot2[ ,i] <- rep(sample(tem.w1,size = b1,replace = T), each = n2)
  }
  ...
  for(i in 1:m3){
    ...
    subplot[,i] <- sample(tem.s,size = b1*n2, replace = T)
  }
