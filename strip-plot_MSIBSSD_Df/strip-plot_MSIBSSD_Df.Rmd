...
```
```{r}
stripplot_MSIBSSD_Df <- function(particle, U2, f, m1, m2, n1, n2, qLB, qGB, w.ratio, iteration, early.break = 100){
  
  #1: Randomly generate a set of balanced N*m SSDs as initial particles
  mSIBSSD.list <- list()
  for(i in 1:particle){
    mSIBSSD.list[[i]] <- generateSPD(m1 = m1, m2 = m2, n1 = n1, n2 = n2)  
  }
...
library(tictoc)
tic()
test <- stripplot_MSIBSSD_Df(particle = particle, U2 = U2, f = f, m1 = m1, m2 = m2, n1 = n1, n2 = n2, qLB = qLB, qGB = qGB, w.ratio = w.ratio, iteration = 5, early.break = 100)
toc()
```
```{r}
test[[1]]

Dcriterion_stripplot(mSSD = test[[1]], U2 = U2, f = f,m1 = m1, m2 = m2, n1 = n1,n2 = n2) 
combn(ncol(test[[1]]), f)
typeof(test[[1]])
```
```{r}
...
Dcriterion_stripplot(mSSD = table5a, U2 = U2, f = 2,m1 = m1, m2 = m2, n1 = n1,n2 = n2) 
Dcriterion_stripplot(mSSD = tem, U2 = U2, f = 2,m1 = m1, m2 = m2, n1 = n1,n2 = n2) 
```
